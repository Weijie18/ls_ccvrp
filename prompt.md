...
Solution quality is the first priority, stability is the basic constraint, and runtime efficiency is the subsequent optimization target. Random seed is important. Every modification must be explainable, testable, and reversible. Use small iterative improvements instead of large-scale one-time reconstruction.
